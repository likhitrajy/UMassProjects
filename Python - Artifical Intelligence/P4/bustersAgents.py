...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        livingDistances = [self.distancer.getDistance(pacmanPosition, pos) for pos in livingPos]

        closestGhostPos = livingPos[livingDistances.index(min(livingDistances))]

        successorPositions = [Actions.getSuccessor(pacmanPosition, action) for action in legal]
        successorDistances = [self.distancer.getDistance(pos, closestGhostPos) for pos in successorPositions]

        minAction = legal[successorDistances.index(min(successorDistances))]
