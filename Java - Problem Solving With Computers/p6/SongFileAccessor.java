...
public class SongFileAccessor extends FileAccessor{
  ...
  */
   public void processLine(String line){
      ...
      String[] arrSongs= line.split(",",0);
       
      if (arrSongs[1] == "") {
         Song song = new Song(arrSongs[0], arrSongs[2], Double.parseDouble(arrSongs[3]));
         songs.addSong(song);
      }
      else {
         Song song = new Song(arrSongs[0], arrSongs[1], arrSongs[2], Double.parseDouble(arrSongs[3]));
         songs.addSong(song);
      }
  ...
  */
   public String getSongsAsCSV(SongList songList){
      ...
      for (Song currSong : songList.getSongList()) {
         songListCSV = songListCSV + songToCSVString(currSong) + "\n";
      }
      return songListCSV;
   }
