...
var v1 = new THREE.Vector3(0.25, 1.5, 0.0);
...
//HW: Creates Octahedron mesh
var octahedron_geometry = new THREE.OctahedronGeometry(1, 1);
var octahedron = new THREE.Mesh(octahedron_geometry, material);
...
function render() {
   ...
   * The Program uses Boolean values which are set to true when the mouse is on the shape and false when its not on the shape.
   *********************************/
	if (mouseClicked) {
